...
```javascript
import logcdf from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-gumbel-logcdf@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-gumbel-logcdf/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-dists-gumbel-logcdf/actions/workflows/test.yml?query=branch:v0.2.2
