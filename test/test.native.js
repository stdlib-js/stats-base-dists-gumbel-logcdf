...
tape( 'if provided `+infinity` for `x` and a finite `mu` and `beta`, the function returns `1`', opts, function test( t ) {
...
tape( 'the function evaluates the log cdf for `x` given positive `mu`', opts, function test( t ) {
	var expected;
	var delta;
	var beta;
	var tol;
...
tape( 'the function evaluates the log cdf for `x` given negative `mu`', opts, function test( t ) {
	var expected;
	var delta;
	var beta;
	var tol;
...
tape( 'the function evaluates the log cdf for `x` given large variance ( = large `beta` )', opts, function test( t ) {
	var expected;
	var delta;
	var beta;
	var tol;
